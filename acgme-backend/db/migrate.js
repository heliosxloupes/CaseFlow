...
const alterStatements = [
  ...
  `ALTER TABLE case_submissions ADD COLUMN IF NOT EXISTS role TEXT`,
  `ALTER TABLE case_submissions ADD COLUMN IF NOT EXISTS site TEXT`,
  `ALTER TABLE case_submissions ADD COLUMN IF NOT EXISTS attending TEXT`,
  `ALTER TABLE case_submissions ADD COLUMN IF NOT EXISTS patient_type TEXT`,
  ...
  `ALTER TABLE case_submissions ALTER COLUMN role TYPE TEXT`,
  `ALTER TABLE case_submissions ALTER COLUMN site TYPE TEXT`,
  `ALTER TABLE case_submissions ALTER COLUMN attending TYPE TEXT`,
  `ALTER TABLE case_submissions ALTER COLUMN patient_type TYPE TEXT`,
  `ALTER TABLE case_submissions ALTER COLUMN case_year TYPE TEXT`,
